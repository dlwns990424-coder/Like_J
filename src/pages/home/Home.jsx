...
export default function Home() {
  ...
  return (
    <main className="min-h-dvh bg-white pb-[120px] text-[#191919]">
      <div className="mx-auto min-h-dvh w-full max-w-[390px]">
        <Header
          left={
            <Link
              to="/home"
              className="text-[28px] font-bold leading-[36px] tracking-[-0.02em]"
            >
              LOGO
            </Link>
          }
          right={
            ...
            >
              ...
              <span className="text-[12px] leading-[18px]">도시검색</span>
            </Link>
          }
        />
